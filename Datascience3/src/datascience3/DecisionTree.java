...
public class DecisionTree {
	...
	public static void main(String[] args) throws Exception {
		...
		int l = 10;
		String trainingSet1 = "E:\\5th Semister\\Database\\decision-tree-java-implementation-master\\src\\data_sets1\\training_set.csv";
		String validationSet1 = "E:\\5th Semister\\Database\\decision-tree-java-implementation-master\\src\\data_sets1\\validation_set.csv";
		String testSet1 = "E:\\5th Semister\\Database\\decision-tree-java-implementation-master\\src\\data_sets1\\test_set.csv";
		Scanner scanner;
		...
		/*for(Map<String,Integer> dataPoint2:trainingDataSet){
			
			for(String key:dataPoint2.keySet()){
				
				System.out.print(key+"-->"+dataPoint2.get(key)+"  ");
			}
			System.out.println();
		}*/
	...
	private static double informationGainForAttribute(List<Map<String, Integer>> dataSet, double initialEntropy,String attribute) {
		int zeroZero = 0;
		int zeroOne = 0;
		int oneZero = 0;
		int oneOne = 0;
